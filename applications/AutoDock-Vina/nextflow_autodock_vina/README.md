...
nextflow run main.nf \
  ...
  --data_dir "$PWD/data" \
  --out_s3 s3://srilekha-new-s3/outputs-vina-test
```
...
Published to:
`s3://srilekha-new-s3/outputs-vina-test/<complex>/`

Example:
```bash
s3://srilekha-new-s3/outputs-vina-test/
├── 1ac8/
├── 1gkc/
├── 1hnn/
└── 1hwi/
```
## Docker Image
* Image: `docker.io/809314/docker_vina:latest`
